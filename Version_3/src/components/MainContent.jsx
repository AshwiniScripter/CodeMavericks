  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-[80px] px-4 justify-center">
        {/* Event */}
        <div className="p-6 rounded-lg shadow-lg text-center max-w-[300px] mx-auto hover:shadow-2xl hover:opacity-90 transition-all duration-300">
          <img
            src={EventImage}
            alt="Event"
          ...
          <button className="flex items-center bg-blue-600 w-[100px] h-[40px] rounded-xl mt-4">
        ...
        <div className="p-6 rounded-lg shadow-lg text-center max-w-[300px] mx-auto hover:shadow-2xl hover:opacity-90 transition-all duration-300">
          ...
          <button className="flex items-center bg-blue-600 w-[140px] h-[40px] rounded-xl mt-4">
